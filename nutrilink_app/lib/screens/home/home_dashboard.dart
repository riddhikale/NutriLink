...
class _HomeDashboardState extends State<HomeDashboard> {
  ...
  void handleIntent(String intent, String language) {
    final Map<String, Map<String, String>> intentSpeech = {
      "add_child_screening":     {"en": "Opening child screening",              "hi": "बच्चे की स्क्रीनिंग खोल रहा हूँ",          "mr": "बाल स्क्रीनिंग उघडत आहे"},
      "add_pregnant_screening":  {"en": "Opening pregnant women screening",     "hi": "गर्भवती महिला स्क्रीनिंग खोल रहा हूँ",    "mr": "गर्भवती महिला स्क्रीनिंग उघडत आहे"},
      "add_beneficiary":         {"en": "Opening beneficiary registration",     "hi": "लाभार्थी पंजीकरण खोल रहा हूँ",             "mr": "लाभार्थी नोंदणी उघडत आहे"},
      "add_screening":           {"en": "Opening screening page",               "hi": "स्क्रीनिंग पेज खोल रहा हूँ",               "mr": "स्क्रीनिंग पेज उघडत आहे"},
      "navigation_settings":     {"en": "Opening settings",                     "hi": "सेटिंग्स खोल रहा हूँ",                     "mr": "सेटिंग्स उघडत आहे"},
      "navigation_work_history": {"en": "Opening work history",                 "hi": "वर्क हिस्ट्री खोल रहा हूँ",               "mr": "वर्क हिस्ट्री उघडत आहे"},
      "navigation_home":         {"en": "Opening home",                         "hi": "होम पेज खोल रहा हूँ",                      "mr": "होम पेज उघडत आहे"},
      "navigation_profile":      {"en": "Opening profile",                      "hi": "प्रोफाइल खोल रहा हूँ",                     "mr": "प्रोफाइल उघडत आहे"},
      "view_followups":          {"en": "Opening followups",                    "hi": "फॉलोअप्स खोल रहा हूँ",                    "mr": "फॉलोअप्स उघडत आहे"},
      "view_high_risk":          {"en": "Opening high risk cases",              "hi": "उच्च जोखिम मामले खोल रहा हूँ",            "mr": "उच्च जोखमीची प्रकरणे उघडत आहे"},
      "view_medium_risk":        {"en": "Opening medium risk cases",            "hi": "मध्यम जोखिम मामले खोल रहा हूँ",           "mr": "मध्यम जोखमीची प्रकरणे उघडत आहे"},
      "view_low_risk":           {"en": "Opening low risk cases",               "hi": "कम जोखिम मामले खोल रहा हूँ",              "mr": "कमी जोखमीची प्रकरणे उघडत आहे"},
    };
    ...
    if (intentSpeech.containsKey(intent)) {
      final response = intentSpeech[intent]![language] ?? intentSpeech[intent]!["en"]!;
      _tts.speak(response, language);
    }

    if (intentRoutes.containsKey(intent)) {
      Navigator.push(context, MaterialPageRoute(builder: (_) => intentRoutes[intent]!()));
  ...
  Widget build(BuildContext context) {
    final pages = [
      ...
      ProfileView(name: _userName, phoneNumber: _userPhone, role: _userRole),
    ];
            ...
            children: [
              Expanded(
                child: InkWell(
                  ...
                  child: Icon(
                    Icons.home,
                    color: _selectedIndex == 0 ? const Color(0xFF2A6DB5) : Colors.grey,
                  ),
                ),
              ),
              ...
              Expanded(
                child: InkWell(
                  ...
                  child: Icon(
                    Icons.person,
                    color: _selectedIndex == 1 ? const Color(0xFF2A6DB5) : Colors.grey,
                  ),
                ),
              ),
            ],
